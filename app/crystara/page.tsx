  ...
  return (
    <>
      <ChapterHeader
        ...
        title="Crystara."
        kicker="A self-organizing extension of JEPA that grows its own predictor architecture at training time through a recursive three-system loop, and emits typed, interpretable, routable modules at inference time. Across three real heterogeneous graphs — Georgetown CSET's semiconductor supply chain (519 entities), GDELT global news events (380 entities), and SEC EDGAR filings (9,725 entities, ~3.9M edges) — Crystara adds +20 to +36.6 AUC points to baseline JEPA on self-supervised link prediction, beats supervised GAT / GCN / GraphSAGE on the semiconductor graph, and scales to entity counts where GAT runs out of memory. On the semiconductor graph, the pipeline discovers 16 interpretable modules that map 1-to-1 to real industry clusters — with no labels, no prompting."
